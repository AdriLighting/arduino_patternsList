...
#define MAIN_H 
    ...
    static const char LPNAME_008[] PROGMEM = "Mystic";
    static const char LPNAME_009[] PROGMEM = "Valentine";
    static const char LPNAME_010[] PROGMEM = "Pépita";
    static const char LPNAME_011[] PROGMEM = "Réglisse(Mon RéRé)";
    static const char LPNAME_012[] PROGMEM = "Crevette(Pot de cole)";
    static const char LPNAME_013[] PROGMEM = "Mimine(MouMoune)";
